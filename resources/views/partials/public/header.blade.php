<header class="site-header" data-site-header>
    ...
    <div class="nav-shell">
        <a href="{{ route('public.home') }}" class="brand" aria-label="{{ config('app.name') }} home">
            <img src="{{ asset('images/logo.png') }}" alt="{{ config('app.name') }}" class="brand-logo navbar-logo" />
        </a>
        ...
        <nav id="site-navigation" class="site-nav" data-site-nav aria-label="Primary navigation">
            <div class="site-nav__drawer-header">
                <a href="{{ route('public.home') }}" class="brand" tabindex="-1">
                    <img src="{{ asset('images/logo.png') }}" alt="{{ config('app.name') }}" class="brand-logo sidebar-logo" />
                </a>
            ...
            <a href="{{ route('public.home') }}" class="{{ request()->routeIs('public.home') ? 'is-active' : '' }}">Welcome</a>
            <a href="{{ route('public.products.index') }}" class="{{ request()->routeIs('public.products.*') ? 'is-active' : '' }}">Our Crafts</a>
            <a href="{{ route('public.pages.about') }}" class="{{ request()->routeIs('public.pages.about') ? 'is-active' : '' }}">Our Journey</a>
            <a href="{{ route('public.contact.show') }}" class="site-nav__mobile-link {{ request()->routeIs('public.contact.*') ? 'is-active' : '' }}">Connect With Us</a>
        ...
        <a class="nav-cta" href="{{ route('public.contact.show') }}">Connect With Us</a>
    </div>
</header>
