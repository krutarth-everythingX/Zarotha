        ...
        <PagePanel>
            <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    ...
                    <Text>
                        Automatically pulls latest published products, capped at
                        10.
                    </Text>
                </div>
                <ToggleField
            ...
            <div className="grid gap-5 lg:grid-cols-2">
                ...
                <Field>
                    ...
                    <FormInput
                        value={form.data.latest.subtitle}
                        onChange={(
                            event: React.ChangeEvent<HTMLInputElement>,
                        ) =>
                            form.setData("latest", {
                ...
                <Field>
                    ...
                    <FormInput
                        ...
                        min={1}
                        max={10}
                        value={form.data.latest.max_items}
                        onChange={(
                            event: React.ChangeEvent<HTMLInputElement>,
                        ) =>
                            form.setData("latest", {
                ...
                <Field>
                    ...
                    <FormInput
                        value={form.data.latest.view_all_label}
                        onChange={(
                            event: React.ChangeEvent<HTMLInputElement>,
                        ) =>
                            form.setData("latest", {
                ...
                <Field>
                    ...
                    <FormInput
                        value={form.data.latest.view_all_url}
                        onChange={(
                            event: React.ChangeEvent<HTMLInputElement>,
                        ) =>
                            form.setData("latest", {
                                ...form.data.latest,
                                view_all_url: event.target.value,
                            })
                        }
                    />
