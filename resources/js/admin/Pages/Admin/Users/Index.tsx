...
export default function UsersIndex({ users, roleOptions }: UsersIndexProps) {
    ...
    return (
        <>
            ...
            <AdminShell
                title="Users"
                description="Manage CMS users and roles. User management remains restricted to super administrators."
            >
                <PagePanel>
                    <form
                    ...
                    {users.data.length === 0 ? (
                        <div className="p-6">
                            <EmptyState
                                ...
                                description="Create CMS users here when additional administrators are needed."
                            />
                        </div>
                    ) : (
                        <>
                ...
                {selectedUser ? (
                    <DetailModal
                        ...
                        badge={
                            <StatusBadge
                                tone={selectedUser.isActive ? "green" : "amber"}
                            >
                        ...
                        actions={
                            selectedUser.isActive ? (
                                <Button
                                    href={`/admin/users/${selectedUser.id}/deactivate`}
                                    method="post"
                                    color="light"
