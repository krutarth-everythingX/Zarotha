...
class DemoDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        ContactInformation::updateOrCreate(['id' => 1], [
            ...
            'location_kicker' => 'Contact Us',
            'location_title' => 'Get In Touch!',
            'location_body' => 'We are available to discuss custom wooden art, furniture, and interior project requirements.',
            'address_label' => 'Workshop',
            'map_embed_url' => 'https://maps.google.com/maps?q=Jaipur%2C%20Rajasthan&z=14&output=embed',
            'map_link_url' => 'https://maps.google.com/?q=Jaipur%2C%20Rajasthan',
